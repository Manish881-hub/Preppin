...
const config: Config = {
	...
	theme: {
		...
		extend: {
			...
			boxShadow: {
				'glass': '0 0 1px 0 rgba(0,0,0,0.05), 0 2px 20px -2px rgba(0,0,0,0.05)',
				'glass-lg': '0 0 1px 0 rgba(0,0,0,0.05), 0 5px 30px -5px rgba(0,0,0,0.1)',
				'glass-hover': '0 0 1px 0 rgba(0,0,0,0.05), 0 5px 30px -2px rgba(0,0,0,0.15)',
