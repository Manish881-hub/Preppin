  ...
  return (
    <AppLayout>
      <div className="home-page page-container animate-fade-in">
        {/* Layout: center feed column, right sidebar */}
        <div className="flex gap-6 items-start">
          {/* Centered feed column (constrained width like Francium) */}
          ...
          {/* Right Container - Companies Sidebar */}
          <aside className="right-container w-[350px] hidden md:block">
